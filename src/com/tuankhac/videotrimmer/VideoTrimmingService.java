package com.tuankhac.videotrimmer;
...
public class VideoTrimmingService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		try {
			int returnStatus = trimmer.trim_(inputFileName, outFileName, start,
					duration);
		...
		String messageText = error ? "Unable to trim the video. Check the error logs."
